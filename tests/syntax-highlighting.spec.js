...
test.describe('Syntax Highlighting', () => {
  test.beforeEach(async ({ page }) => {
    ...
    const syntaxCheckbox = page.locator(
      'label:has-text("Syntax Highlighting") input[type="checkbox"]',
    );
  ...
  test('should render markdown with proper syntax highlighting', async ({
    page,
  }) => {
  ...
  test('should highlight different markdown elements correctly', async ({
    page,
  }) => {
    ...
    await page
      .locator('#cursor')
      .pressSequentially('**bold text** and *italic text*');
    await page.waitForTimeout(200);
  ...
  test('should maintain highlighting when content changes', async ({
    page,
  }) => {
    ...
    await page
      .locator('#cursor')
      .pressSequentially('# Initial Header\n\nSome **bold** text.');
    await page.waitForTimeout(200);
...
test.describe('Syntax Highlighting Initial Render', () => {
      ...
      origins: [
        {
          ...
          localStorage: [
            ...
            {
              name: 'pluginConfig',
              value: JSON.stringify({ syntaxHighlighting: { enabled: true } }),
            },
          ],
        },
      ],
  ...
  test('should render markdown with proper syntax highlighting at start', async ({
    page,
  }) => {
    await page.goto('/');
    const textRenderer = page.locator('#text');
